 ...
 * Displays transactions for a specific coin with infinite scroll and date grouping
 */
...
import { useInfiniteCoinTransactions, type Transaction } from '@/hooks/useTransactions';
...
export function CoinTransactionList({
  ...
  const {
    ...
    isLoading,
    isError,
  } = useInfiniteCoinTransactions(baseTokenId, 15);
