 ...
 * ============================================================================
 *
 * This page previously displayed a list of the user's support tickets with
 * filtering options (all, open, resolved). It fetched tickets from the
 * /api/support/tickets endpoint and displayed them using TicketCard components.
 *
